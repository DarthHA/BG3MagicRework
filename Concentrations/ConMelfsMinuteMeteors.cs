...
{
    public class ConMelfsMinuteMeteors : BaseConcentration
    {
        ...
        public override bool UpdateAndDecide(Player player)
        {
            ...
            if (!Main.projectile[projIndex].active || Main.projectile[projIndex].type != ModContent.ProjectileType<MelfsMinuteMeteorsController>()) return false;
            return true;
        }
    }
}
