...
{
    public class BurningHandsSpell : BaseSpell
    {
        public override string Name => "BurningHands";
        public override Color NameColor => Color.OrangeRed;
        public override SchoolOfMagic Shool => SchoolOfMagic.Evocation;
        public override DiceDamage BaseDamage => new(6, 3, DamageElement.Fire, CombatStat.Ring1Damage);

        public override DiceDamage RisingDamageAddition => new(6, 1, DamageElement.Fire, CombatStat.Ring1Damage);
        ...
        public override void Shoot(Player player, ModProjectile modproj, Vector2 tipPosition, Vector2 mousePosition, int Ring)
        {
            ...
            int protmp = player.NewMagicProj(tipPosition, Vel, ModContent.ProjectileType<BurningHandsProj>(), player.GetDiceDamage(BaseDamage, InitialRing, Ring, RisingDamageAddition), 0, Ring);
