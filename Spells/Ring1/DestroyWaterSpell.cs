...
{
    public class DestroyWaterSpell : BaseSpell
    {
        public override string Name => "DestroyWater";
        ...
        {
            int protmp = player.New1DmgMagicProj(mousePosition, Vector2.Zero, ModContent.ProjectileType<DestroyWaterProj>(), Ring);
            if (protmp >= 0 && protmp < 1000)
            {
                (Main.projectile[protmp].ModProjectile as BaseMagicProj).ActivateMetaMagic(player, true, true, false, false, false);
